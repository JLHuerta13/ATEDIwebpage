        ...
        <div class="gallery">
            <div class="small-images" style="display: flex; justify-content: space-around; margin-top: 10px;">
                <div class="image-container">
                    ...
                    <p class="description">Personal de ATEDI brindando asesoría de sistema de lectoescritura Braille a
                        estudiante de secundaria.</p>
                </div>
                <div class="image-container">
                    <img src="img/Sala_multi/sala13.jpg" alt="" style="width: 90%; border-radius: 8px;">
                    <p class="description">Personal de ATEDI verificando las figuras impresas en Braille.</p>
                </div>
                <div class="image-container">
                    <img src="img/Sala_multi/sala3.jpg" alt="" style="width: 90%; border-radius: 8px;">
                    <p class="description">Personal de ATEDI impartiendo taller de lectoescritura Braille a estudiante
                        de universidad.</p>
                </div>
            </div>
            <div class="small-images" style="display: flex; justify-content: space-around; margin-top: 10px;">
                ...
                <div class="image-container">
                    ...
                    <p class="description">Cabina multifuncional con 2 impresoras de Braille y computadora para
        ...
        <div class="gallery">
            ...
            <div class="small-images" style="display: flex; justify-content: space-around; margin-top: 10px;">
                <div class="image-container">
                    ...
                    <p class="description">Usuario de silla de ruedas ejecitándose.</p>
                </div>
                <div class="image-container">
    ...
    <section class="container">
        <div class="gallery">
            <div class="small-images" style="display: flex; justify-content: space-around; margin-top: 10px;">
                ...
                <div class="image-container">
                    <img src="img/Admision/admision1.jpg" alt="" style="width: 80%; border-radius: 8px;">
